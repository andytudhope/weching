...
function Button({ className, variant = "default", size = "default", asChild = false, ...props }) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, { "data-slot": "button", "data-variant": variant, "data-size": size, className: (0, utils_1.cn)(buttonVariants({ variant, size, className })), ...props }));
}
